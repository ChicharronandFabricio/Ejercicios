...
window.addEventListener("load",()=>{
    ...
    setTimeout(()=>{
        imgInicio.classList.add("mostrar");
    }, 700);
...
const RUTINAS = [
  {
    ...
    ejercicios: [
      ...
      {
        nombre: "Curl Lateral en Supinación Aislado con Polea",
        musculoImg: "imgs/musculo_2.png",
        gif: "gifs/Curl_Lateral_Supinación_Aislado_Polea.gif"
      },
      {
        nombre: "press banca inclinado",
        musculoImg: "imgs/musculos1.png",
        gif: "gifs/press_banca_inclinado.gif"
      },
      {
        nombre: "jalon en maquina pulldow",
        musculoImg: "imgs/Musculo_3.png",
        gif: "gifs/jalon_maquina_pulldow.gif"
      },
      {
        nombre: "jalon en maquina lat pulldow con triangulo",
        musculoImg: "imgs/Musculo_3.png",
        gif: "gifs/jalon_maquina_lat_pulldow_triangulo.gif"
      },
      {
        nombre: "remo en maquina",
        musculoImg: "imgs/Musculo_4.png",
        gif: "gifs/remo_maquina.gif"
      },
      {
        nombre: "Remo Superior con Cuerda en Polea",
        musculoImg: "imgs/Musculo_4.png",
        gif: "gifs/Remo_Superior_Cuerda_Polea.gif"
      },
      {
        nombre: "remo en polea unilateral",
        musculoImg: "imgs/Musculo_4.png",
        gif: "gifs/remo_polea_unilateral.gif"
      },
      {
        nombre: "pectoral fly",
        musculoImg: "imgs/musculos1.png",
        gif: "gifs/pectoral_fly.gif"
      },
      {
        nombre: "pull over en polea",
        musculoImg: "imgs/Musculo_4.png",
        gif: "gifs/pull_over_polea.gif"
      },
      {
        nombre: "jalon polea unilateral derecha",
        musculoImg: "imgs/Musculo_5.png",
        gif: "gifs/jalon_polea_unilateral_derecha.gif"
      },
      {
        nombre: "Extensiones Cruzadas en Polea Alta",
        musculoImg: "imgs/Musculo_6.png",
        gif: "gifs/Extensiones_Cruzadas_Polea_Alta.gif"
      }
    ]
  },
  {
    ...
    ejercicios: [
      { nombre: "press militar maquina", musculoImg: "imgs/musculo_7.png", gif: "gifs/press_militar_maquina.gif" },
      { nombre: "remo al menton en polea", musculoImg: "imgs/deltoides_laterales.png", gif: "gifs/remo_menton_polea.gif" },
      { nombre: "remo al menton con cuerda en polea", musculoImg: "imgs/deltoides_laterales.png", gif: "gifs/remo_menton_cuerda_polea.gif" },
      { nombre: "elevacion lateral polea", musculoImg: "imgs/deltoides_laterales.png", gif: "gifs/elevacion_lateral_polea.gif" },
      { nombre: "elevación lateral sentado alternado con mancuerna", musculoImg: "imgs/deltoides_laterales.png", gif: "gifs/elevación_lateral_sentado_alternado_mancuerna.gif" },
      { nombre: "vuelo posterior en polea", musculoImg: "imgs/Deltoide_posterior.png", gif: "gifs/vuelo_posterior_polea.gif" },
      { nombre: "vuelo posterior alternado en maquina", musculoImg: "imgs/Deltoide_posterior.png", gif: "gifs/vuelo_posterior_alternado_maquina.gif" },
      { nombre: "bíceps en maquina Scott", musculoImg: "imgs/biceps.png", gif: "gifs/bíceps_maquina_Scott.gif" },
      { nombre: "bíceps en maquina", musculoImg: "imgs/biceps.png", gif: "gifs/bíceps_maquina.gif" },
      { nombre: "curl con barra romana", musculoImg: "imgs/biceps.png", gif: "gifs/curl_barra_romana.gif" },
      { nombre: "curl de bíceps en polea alta con barra", musculoImg: "imgs/biceps.png", gif: "gifs/curl_bíceps_polea_alta_barra.gif" },
      { nombre: "triceps polea", musculoImg: "imgs/triceps.png", gif: "gifs/triceps_polea.gif" },
      { nombre: "press francés barra", musculoImg: "imgs/triceps.png", gif: "gifs/press_francés_barra.gif" },
      { nombre: "triceps polea sobre la cabeza", musculoImg: "imgs/triceps.png", gif: "gifs/triceps_polea_sobre_cabeza.gif" }
    ]
  },
  {
    id: "rutina3",
    nombre: "Piernas",
    ejercicios: [
      { nombre: "aductor de cadera", musculoImg: "imgs/aducto_cadera.png", gif: "gifs/aductor_cadera.gif" },
      { nombre: "abductor de cadera", musculoImg: "imgs/aductores.png", gif: "gifs/abductor_cadera.gif" },
      { nombre: "leg curl", musculoImg: "imgs/isquitibiales.png", gif: "gifs/leg_curl.gif" },
      { nombre: "leg press 45", musculoImg: "imgs/cuadriceps.png", gif: "gifs/leg_press_45.gif" },
      { nombre: "sentadilla smith", musculoImg: "imgs/cuadriceps.png", gif: "gifs/sentadilla_smith.gif" },
      { nombre: "leg extensión", musculoImg: "imgs/cuadriceps.png", gif: "gifs/leg_extensión.gif" },
      { nombre: "seated leg curl", musculoImg: "imgs/isquitibiales.png", gif: "gifs/seated_leg_curl.gif" },
      { nombre: "seated calf", musculoImg: "imgs/gemelos.png", gif: "gifs/seated_calf.gif" },
      { nombre: "calf leg press 45", musculoImg: "imgs/gemelos.png", gif: "gifs/calf_leg_press_45.gif" }
    ]
  }
];
